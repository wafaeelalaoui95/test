...
export const translations: Record<Locale, Translations> = {
  fr: {
    ...
    hero_subtitle: 'Envoyez vos affaires avec un voyageur. Prix libres, fixés entre vous. Simple, humain, à l\'international.',
  ...
  en: {
    ...
    hero_subtitle: 'Send your stuff with a traveller. Prices are open, set between you. Simple, human, international.',
