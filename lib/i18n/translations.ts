...
export type Translations = {
  ...
  hero_traveler_prompt: string;
  hero_traveler_cta: string;
  ...
  env_publish_free_title: string;
  env_publish_free_cta: string;
...
export const translations: Record<Locale, Translations> = {
  fr: {
    ...
    hero_subtitle: 'Envoyez vos affaires avec un voyageur. Prix libres, fixés entre vous. Simple, humain, entre voyageurs à travers le monde.',
    hero_search_from: 'Ville de départ',
    hero_search_to: 'Ville d\'arrivée',
    hero_search_button: 'Trouver un voyageur',
    hero_traveler_prompt: 'Vous voyagez bientôt ?',
    hero_traveler_cta: 'Gagnez de l’argent en transportant un colis',
    ...
    prof_starting_from: 'Prix',
    prof_jibly_protection_included: 'frais de service inclus',
    ...
    prof_jibly_protection_fee: 'Frais de service Jibly',
    prof_total: 'Total',
    ...
    env_no_traveler_publish_hint: 'Publiez votre demande gratuitement : les voyageurs qui passeront par cette route la verront et pourront vous proposer leur aide. Vous ne payez que si vous acceptez une proposition.',
    env_publish_free_title: 'Publiez votre demande gratuitement',
    env_publish_free_cta: 'Publier ma demande',
    ...
    env_protection_title: 'Paiement sécurisé',
    env_protection_desc: 'Le paiement est sécurisé : le voyageur est payé après confirmation de la livraison, ou 3 jours après une preuve de livraison si personne ne signale de problème.',
    ...
    send_placeholder_description: 'Ex : acte de naissance, dans une enveloppe non fermée',
    ...
    trust_q2_text: 'Oui, toujours. Avant d\'accepter, le voyageur doit pouvoir voir ce qu\'il va transporter. Un médicament peut rester dans son emballage d\'origine du fabricant — ce qui compte, c\'est que le voyageur voie de quoi il s\'agit. En revanche, il ne doit jamais accepter un colis opaque ou refermé qu\'il ne peut pas vérifier.',
   ...
   cat_documents: 'Documents',
    ...
    send_certify_otc_disclaimer: 'Les médicaments doivent être SANS ordonnance, dans leur emballage d\'origine du fabricant, max 2 unités. Le voyageur doit pouvoir voir de quoi il s\'agit. J\'assume la responsabilité légale du contenu.',
    ...
    footer_tagline: 'Une communauté de voyageurs vérifiés, sur vos routes.',
    ...
    tp_pay_footnote: '🔒 Votre paiement est sécurisé jusqu\'à la confirmation de la livraison.',
    tp_pillars_eyebrow: 'Comment ça vous protège',
    tp_pillars_title: 'Quatre piliers de sécurité',
    tp_pillar1_title: 'Identités vérifiées',
    tp_pillar1_body: 'Pièce d\'identité et selfie biométrique via Stripe Identity, pour les expéditeurs comme pour les voyageurs.',
    tp_pillar2_title: 'Paiement sécurisé',
    tp_pillar2_body: 'Le paiement est sécurisé et le voyageur est payé après confirmation de la livraison.',
    ...
    tp_pillar4_title: 'Assistance en cas de litige',
    tp_pillar4_body: 'Notre équipe peut examiner les signalements et intervenir lorsque nécessaire.',
    ...
    tp_faq_a2: 'Votre paiement est sécurisé et n\'est versé au voyageur qu\'une fois la livraison confirmée. Si personne ne confirme alors que le voyageur a déposé une preuve de livraison, le paiement est débloqué automatiquement après 3 jours, sauf si vous signalez un problème avant. En cas de souci, vous pouvez ouvrir un signalement depuis votre espace : notre équipe peut l\'examiner et intervenir.',
    tp_faq_q3: 'Que se passe-t-il si quelqu\'un ne respecte pas son engagement ?',
    tp_faq_a3: 'L\'identité de tous nos utilisateurs est vérifiée via Stripe Identity (pièce d\'identité + selfie), ce qui permet de donner suite aux comportements abusifs. Vous pouvez signaler tout problème depuis votre espace : notre équipe examine les signalements et peut restreindre un compte lorsque c\'est justifié.',
    ...
    tp_faq_a5: 'Jibly est conçu pour transporter des objets du quotidien : documents, clés, petits effets personnels, et des médicaments sans ordonnance. Les objets de grande valeur, les bijoux et l\'argent liquide ne sont pas autorisés — voir la page « Objets autorisés ».',
    tp_contact_title: 'Une autre question ?',
    tp_contact_body_before: 'Écrivez-nous à',
    tp_contact_body_after: '- nous vous répondons dès que possible.',
    tp_cta_title: 'Prêt à essayer ?',
    tp_cta_body: 'Rejoignez la communauté de voyageurs et d\'expéditeurs Jibly. Vous ne payez que lorsqu\'un voyageur accepte votre colis.',
    ...
    oa_otc_p2: 'Quantité maximum : 2 unités par produit, dans leur emballage d\'origine du fabricant — que le voyageur doit pouvoir voir et identifier. L\'expéditeur déclare et assume la responsabilité légale du contenu.',
    ...
    oa_consequences_p1: 'Tout colis contenant un objet interdit peut entraîner la',
    oa_consequences_strong1: 'suspension',
    oa_consequences_p2: 'du compte concerné, la',
    oa_consequences_strong2: 'conservation des preuves',
    oa_consequences_p3: 'à des fins légales et, si nécessaire, leur',
    oa_consequences_strong3: 'transmission aux autorités',
    oa_consequences_p4: 'compétentes.',
    ...
    me2_category_unlisted:
      'À noter : vous n’aviez pas coché cette catégorie pour ce voyage. Vous pouvez tout de même accepter.',
    me2_accept_check_label: 'Je confirme avoir lu la description de l’objet, je pourrai l’inspecter avant de partir, et je sais que je peux refuser sans pénalité si l’objet ne correspond pas, s’il est dans un contenant que je ne peux pas ouvrir, ou s’il me met mal à l’aise.',
    ...
    me2_pill_delivered_give_code: 'Livré · demandez le code',
    ...
    pickup_show_body_delivery: 'Communiquez ce code au voyageur au moment de la remise : il le saisit pour enregistrer la livraison. Ne le donnez qu’une fois le colis en main. Si un proche réceptionne à votre place, transmettez-le lui.',
    ...
    rev_dispute_intro_after: '. Notre équipe pourra examiner votre signalement et intervenir lorsque nécessaire.',
    ...
    rev_respond_jibly_protection: 'Frais de service Jibly',
  ...
  en: {
    ...
    hero_subtitle: 'Send your stuff with a traveller. Prices are open, set between you. Simple, human, between travellers across the world.',
    hero_search_from: 'Departure city',
    hero_search_to: 'Arrival city',
    hero_search_button: 'Find a traveler',
    hero_traveler_prompt: 'Travelling soon?',
    hero_traveler_cta: 'Earn money carrying a parcel',
    ...
    prof_starting_from: 'Price',
    prof_jibly_protection_included: 'service fee included',
    ...
    prof_jibly_protection_fee: 'Jibly service fee',
    prof_total: 'Total',
    ...
    env_no_traveler_publish_hint: 'Publish your request for free: travellers heading that way will see it and can offer to help. You only pay if you accept an offer.',
    env_publish_free_title: 'Publish your request for free',
    env_publish_free_cta: 'Publish my request',
    ...
    env_protection_title: 'Payment held until delivery',
    env_protection_desc: 'The payment is secured: the traveller is paid once delivery is confirmed, or 3 days after proof of delivery if nobody reports a problem.',
    ...
    send_label_description: 'Description',
    send_placeholder_description: 'E.g. birth certificate, in an unsealed envelope',
    ...
    trust_q2_text: 'Yes - always. Before accepting, the traveller must be able to see what they will be carrying. Medication can stay in its original manufacturer packaging — what matters is that the traveller can see what it is. What they must never accept is an opaque or resealed parcel they cannot check.',
   ...
   cat_documents: 'Documents',
    ...
    send_certify_otc_disclaimer: 'Medication must be over-the-counter, in its original manufacturer packaging, max 2 units. The traveller must be able to see what it is. I assume legal responsibility for the content.',
    ...
    footer_tagline: 'A verified traveller community, on your routes.',
    ...
    tp_pay_footnote: '🔒 Your payment is secured until the delivery is confirmed.',
    tp_pillars_eyebrow: 'How you are protected',
    tp_pillars_title: 'Four pillars of safety',
    tp_pillar1_title: 'Verified identities',
    tp_pillar1_body: 'Photo ID and a biometric selfie through Stripe Identity, for senders and travellers alike.',
    tp_pillar2_title: 'Payment held until delivery',
    tp_pillar2_body: 'The payment is secured, and the traveller is paid once the delivery is confirmed.',
    tp_pillar3_title: 'Double confirmation',
    tp_pillar3_body: 'Unique 4-digit codes for handover and delivery. No room for doubt.',
    tp_pillar4_title: 'Help when something goes wrong',
    tp_pillar4_body: 'Our team can look into reports and step in where needed.',
    ...
    tp_faq_a2: 'Your payment is secured and only reaches the traveller once the delivery is confirmed. If nobody confirms but the traveller has uploaded proof of delivery, the payment is released automatically after 3 days — unless you report a problem before then. If something goes wrong you can report it from your account, and our team can look into it and step in.',
    tp_faq_q3: 'What happens if someone doesn\'t keep their commitment?',
    tp_faq_a3: 'Every user\'s identity is verified through Stripe Identity (photo ID + selfie), which lets us follow up on abusive behaviour. You can report any problem from your account: our team reviews reports and can restrict an account where that is warranted.',
    ...
    tp_faq_a5: 'Jibly is built for everyday items: documents, keys, small personal belongings, and over-the-counter medication. High-value items, jewellery and cash are not allowed — see the "Allowed items" page.',
    tp_contact_title: 'Still have a question?',
    tp_contact_body_before: 'Drop us a line at',
    tp_contact_body_after: '- we get back to you as soon as we can.',
    tp_cta_title: 'Ready to give it a try?',
    tp_cta_body: 'Join the Jibly community of travellers and senders. You only pay once a traveller takes your parcel on.',
    ...
    oa_otc_p2: 'Maximum quantity: 2 units per product, in their original manufacturer packaging — which the traveller must be able to see and identify. The sender declares and assumes legal responsibility for the contents.',
    ...
    oa_consequences_p1: 'Any parcel containing a forbidden item can lead to the',
    oa_consequences_strong1: 'suspension',
    oa_consequences_p2: 'of the account concerned, the',
    oa_consequences_strong2: 'retention of evidence',
    oa_consequences_p3: 'for legal purposes and, where necessary, its',
    oa_consequences_strong3: 'transmission to the relevant',
    oa_consequences_p4: 'authorities.',
    ...
    me2_category_unlisted:
      'Note: you didn’t tick this category for this trip. You can still accept it.',
    me2_accept_check_label: 'I confirm I have read the item description, that I will be able to inspect it before leaving, and that I can refuse without penalty if the item does not match, if it is in a container I cannot open, or if it makes me uncomfortable.',
    ...
    me2_pill_delivered_give_code: 'Delivered · ask for the code',
    ...
    pickup_show_body_delivery: 'Give this code to the traveler at drop-off: they enter it to record the delivery. Only give it once the parcel is in hand. If a relative receives on your behalf, share it with them.',
    ...
    rev_dispute_intro_after: '. Our team can review your report and step in where needed.',
    ...
    rev_respond_jibly_protection: 'Jibly service fee',
