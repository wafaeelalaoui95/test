...
export const translations: Record<Locale, Translations> = {
  fr: {
   ...
   cat_documents: 'Documents',
    ...
    oa_consequences_strong1: 'suspension du compte',
    oa_consequences_p2: 'de l’expéditeur et du voyageur, la',
  ...
  en: {
   ...
   cat_documents: 'Documents',
    ...
    oa_consequences_strong1: 'suspension of the accounts',
    oa_consequences_p2: 'of the sender and the traveller, the',
