...
import { PayoutCountriesNotice } from '@/components/layout/PayoutCountriesNotice';
    ...
    <html lang="fr" suppressHydrationWarning>
      <body className="min-h-screen bg-cream-50 text-ink-500">
        <I18nProvider>
          <AuthProvider>
            <MessagingProvider>
              {/* Above the navbar: a traveler should meet this before they
                  commit to carrying anything, not at payout setup. */}
              <PayoutCountriesNotice />
              <Navbar />
