    ...
    sections: [
      {
        ...
        paragraphs: [
          'Jibly est responsable du traitement des données collectées via la plateforme. Pour toute question relative à vos données, contactez-nous à hello@jibly.com.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Pour exercer ces droits, écrivez à hello@jibly.com. Vous pouvez également introduire une réclamation auprès de la CNIL.',
        ],
      },
      {
        title: '8. Cookies',
    ...
    sections: [
      {
        ...
        paragraphs: [
          'Jibly is the controller of the data collected through the platform. For any question about your data, contact us at hello@jibly.com.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'To exercise these rights, email hello@jibly.com. You may also lodge a complaint with your data protection authority (e.g. the CNIL in France).',
        ],
      },
      {
        title: '8. Cookies',
