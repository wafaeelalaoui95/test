    ...
    sections: [
      {
        ...
        paragraphs: [
          'Jibly est responsable du traitement des données collectées via la plateforme. Pour toute question relative à vos données, contactez-nous à contact@jibly.io.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Pour exercer ces droits, écrivez à contact@jibly.io. Vous pouvez également introduire une réclamation auprès de la CNIL.',
        ],
      },
      {
        title: '8. Cookies',
    ...
    sections: [
      {
        ...
        paragraphs: [
          'Jibly is the controller of the data collected through the platform. For any question about your data, contact us at contact@jibly.io.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'To exercise these rights, email contact@jibly.io. You may also lodge a complaint with your data protection authority (e.g. the CNIL in France).',
        ],
      },
      {
        title: '8. Cookies',
