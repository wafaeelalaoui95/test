...
/**
 * Pickup code display modal — shown to the SENDER when they're meeting
 * the traveler to hand over the parcel.
 *
 ...
 *
 * Why visible to sender (and not, say, only after a "I'm here" tap):
 * we want zero friction at the meeting moment. The code is gated by
 * RLS anyway — only the sender of THIS booking can read it.
 */
          ...
          >
            ...
            <div className="px-6 pb-6">
              <p className="text-[14px] text-ink-500 leading-relaxed mb-5">
                Communiquez ce code à <strong className="text-ink-600">{travelerName}</strong> sur place.
                Il devra le saisir dans son application pour confirmer qu&apos;il a bien récupéré votre colis.
              </p>
              ...
              {/* Copy button — useful if sender wants to send it via message */}
              <button
                type="button"
                onClick={copyCode}
              ...
              <p className="text-[11px] text-ink-400 text-center mt-4 leading-relaxed">
                🔒 Ne partagez ce code <strong>qu&apos;au moment</strong> de la remise en main propre.
              </p>
            </div>
          </motion.div>
        </>
